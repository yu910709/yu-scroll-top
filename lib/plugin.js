...
var Plugin = function () {
    ...
    _createClass(Plugin, [{
        ...
        value: function init() {
             ...
             * @type {Set<string>}
             */
            var allowParams = new Set(['zIndex', 'icon', 'shape', 'background', 'color', 'text', 'hover', 'btnLike', 'correct', 'position', 'animation', 'distance', 'ready', 'callback']);
            ...
            //何时显示DOM
            var _this = this;
            this.option.distance = typeof this.option.distance === 'number' ? this.option.distance : 50;
